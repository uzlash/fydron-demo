...
const ACME_PROFILE: ClientProfile = {
  ...
  legal: {
    ...
    address: "Supi 21, 10102AA Amsterdam",
    country: "Netherlands",
  ...
  frameworks: [
    ...
    { id: "f5", name: "ISO 45001", progress: 85, lastUpdated: "2nd Apr, 2026", matrixDossierId: MATRIX_ACTIVATION_DOSSIER_ID },
    { id: "f6", name: "ISO 001-2022", progress: 85, lastUpdated: "2nd Apr, 2026", matrixDossierId: MATRIX_ACTIVATION_DOSSIER_ID },
    { id: "f7", name: "NEN 101", progress: 85, lastUpdated: "2nd Apr, 2026", matrixDossierId: MATRIX_ACTIVATION_DOSSIER_ID },
  ],
};
