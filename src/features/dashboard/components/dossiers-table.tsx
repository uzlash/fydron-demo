...
/** Fydron V2 Figma: Uploader (grey), Contributor (pink), Reviewer (dark), Auditor (brand blue) */
        ...
        <table className="w-full border-collapse text-[13px]">
          <thead className="sticky top-0 z-10 border-b border-border bg-surface text-left text-[13px] font-medium tracking-tight text-secondary">
            ...
            {rows.map((row) => (
              <tr
                key={row.id}
                className="border-b border-border-soft transition-colors last:border-0 hover:bg-surface-muted/80"
              >
